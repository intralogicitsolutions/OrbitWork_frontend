...
class ConsultationController extends GetxController{
  ...
  final List<ServiceProvider> serviceProviders = [
    ServiceProvider(
      ...
      price: "from \$3",
      imageUrl: "https://via.placeholder.com/80x60/4A90E2/FFFFFF?text=CREATIVE",
      profileImage: "https://via.placeholder.com/48x48/FF6B6B/FFFFFF?text=SS",
      isTopRatedPlus: true,
    ...
    ServiceProvider(
      ...
      title: "Development & IT Consultation",
      price: "from \$10",
      imageUrl: "https://via.placeholder.com/80x60/50C878/FFFFFF?text=TOTAL+JOBS",
      profileImage: "https://via.placeholder.com/48x48/4ECDC4/FFFFFF?text=MO",
      isTopRatedPlus: true,
      badge: "Top Rated Plus",
      isInitiallySaved: false,
    ),
    ServiceProvider(
      ...
      title: "Development & IT Consultation",
      price: "from \$40",
      imageUrl: "https://via.placeholder.com/80x60/9B59B6/FFFFFF?text=ENTERPRISE",
      profileImage: "https://via.placeholder.com/48x48/34495E/FFFFFF?text=NJ",
