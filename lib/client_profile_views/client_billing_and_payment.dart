...
class ClientBillingAndPayments extends StatelessWidget{
                ...
                children: [
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text('Company billing cycle', style: TextStyle(
                          fontSize: 20, fontWeight: FontWeight.w500
                        ),),
                        SizedBox(height: 12,),
                        Text('Weekly',style: TextStyle(fontWeight: FontWeight.w300),),
                        SizedBox(height: 40,),
                        Row(
                          children: [
                            Text('Terms:'),
                            Text('Standard', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500),)
                          ],
                        )
                      ],
                    ),
                  ...
                  Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Balance: \$0.00', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w500),),
                        SizedBox(height: 12,),
                        Container(
                          width: Get.width,
                          child: ElevatedButton(
                            style: ElevatedButton.styleFrom(
                              ...
                              onPressed: () {}, child: Text('Pay now', style: TextStyle(
                            color: Colors.grey
                          ),)),
                        )
                      ],
                  ...
                  SizedBox(height: 24,),
                  if(!controller.showAddBillingMethod.value)
                  _buildBillingMethods(),
                  if(controller.showAddBillingMethod.value)
                  _addBillingMethod(),
                ],
              ),
  ...
  Widget _buildBillingMethods() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Billing methods', style: TextStyle(
          fontSize: 20, fontWeight: FontWeight.w500
        ),),
        SizedBox(height: 16,),
        Text('You haven\'t set up any billing methods yet. Add a method so you can hire when you\'re ready.', style: TextStyle(
  ...
  Widget _buildAddBillingButton() {
    return TextButton.icon(
      onPressed: () {
        controller.toggleBillingMethod();
  ...
  Widget _addBillingMethod() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Add a billing method', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w500),),
        SizedBox(height: 20,),
        _buildCancelButton(),
        SizedBox(height: 20,),
