...
import 'package:orbitwork/client_profile_views/client_profile.dart';
...
import 'package:orbitwork/views/view_offer_page.dart';
...
class AppPages {
  static final routes = [
    ...
    GetPage(name: AppRoutes.paymentPage, page: () => Subscriptionpage()), // only for testing ///////////
    ...
    GetPage(name: AppRoutes.viewOffer, page: () => ViewOffer(),),
    ...
    GetPage(name: AppRoutes.talentSearchScreen, page: () => TalentSearchScreen(),),
    GetPage(name: AppRoutes.clientProfilePage, page: () => ClientProfilePage(),),
