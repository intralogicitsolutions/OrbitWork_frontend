...
class DisplaySettingBottomsheet extends StatelessWidget {
  final DisplaySettingController controller =
      Get.put(DisplaySettingController());
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Obx(() {
                      final value = controller.selectedColumn.value;
                      final items = controller.columns;
                              ...
                              child: Column(
                                ...
                                children: items.map((col) {
                                  return ListTile(
                                    title: Text(col),
                                    onTap: () {
                                      controller.selectedColumn.value = col;
